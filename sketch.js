...
function preload(){
  gameOver_image = loadImage("PNG/gameOver.png")
  ...
  alien_dead = loadAnimation("2d-Game-Alien-Character-Free-Sprite/alien/PNG/alien_green/green_dead.png")
...
*/
  ...
  alien = createSprite(500,115,20,50)
  alien.addAnimation("attack", alien_attack1)
  alien.addAnimation("idle", alien_idle)
  alien.addAnimation("dead", alien_dead)
  alien.scale = 0.25


good.setCollider("circle",-10,20,25)
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(good.isTouching(alien)){
      gameState = END;
      good.velocityX = 0;
      alien.y = 180
      alien.changeAnimation("dead", alien_dead)
      score = score + 5;
    }
    ...
    if (keyWentDown('d')){
      good.velocityX = 3
      good.changeAnimation("running", good_running);
    }
    if(keyWentUp("d")){
      good.velocityX = 0;
    }
    if (keyWentDown("a")){
      ...
      good.velocityX = -3
      good.changeAnimation("runleft", good_leftrun)
    }
    if(keyWentUp("a")){
      good.velocityX = 0;
    }
